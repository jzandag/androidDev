 ...
 */
public class Level14 extends ZidPlayScreens implements Screen {
    private static final int LEVEL_NUMBER = 14;

    public Level14(Elective4 game) {
        super(game);
        // Only changes needed
        map = new TmxMapLoader().load("map/Level 14 Forest Woods Room.tmx");
        player = new Player(world,this, 7,12);
    }
