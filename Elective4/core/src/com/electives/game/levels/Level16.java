 ...
 */
public class Level16 extends ZidPlayScreens implements Screen {
    private static final int LEVEL_NUMBER = 16;

    public Level16(Elective4 game) {
        super(game);
        // Only changes needed
        map = new TmxMapLoader().load("map/Level 16 Storage Room .tmx");
        player = new Player(world,this, 2,11);
    }
