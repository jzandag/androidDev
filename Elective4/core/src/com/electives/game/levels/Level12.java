 ...
 */
public class Level12 extends ZidPlayScreens implements Screen {
    private static final int LEVEL_NUMBER = 12;

    public Level12(Elective4 game) {
        super(game);
        // Only changes needed
        map = new TmxMapLoader().load("map/Level 12 Campsite Room.tmx");
        player = new Player(world,this, 5,14);
    }
