 ...
 */
public class Level17 extends ZidPlayScreens implements Screen {
    private static final int LEVEL_NUMBER = 17;

    public Level17(Elective4 game) {
        super(game);
        // Only changes needed
        map = new TmxMapLoader().load("map/Level 17 Port Room.tmx");
