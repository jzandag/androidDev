 ...
 */
public class Level13 extends ZidPlayScreens implements Screen {
    private static final int LEVEL_NUMBER = 13;

    public Level13(Elective4 game) {
        super(game);
        // Only changes needed
        map = new TmxMapLoader().load("map/Level 13 Dining Room.tmx");
