 ...
 */
public class Level05 extends ZidPlayScreens implements Screen {
    private static final int LEVEL_NUMBER = 5;

    public Level05(Elective4 game) {
        super(game);
        // Only changes needed
        map = new TmxMapLoader().load("map/Level 05 Mountain Room.tmx");
        player = new Player(world,this, 11,14);
    }
