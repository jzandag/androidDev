 ...
 */
public class Level08 extends ZidPlayScreens implements Screen {
    private static final int LEVEL_NUMBER = 8;

    public Level08(Elective4 game) {
        super(game);
        // Only changes needed
        map = new TmxMapLoader().load("map/Level 08 Comfort Room.tmx");
        player = new Player(world,this, 11,10);
    }
