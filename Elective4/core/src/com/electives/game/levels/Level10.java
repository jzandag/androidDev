 ...
 */
public class Level10 extends ZidPlayScreens implements Screen {
    private static final int LEVEL_NUMBER = 10;

    public Level10(Elective4 game) {
        super(game);
        // Only changes needed
        map = new TmxMapLoader().load("map/Level 10 Sewage Room.tmx");
        player = new Player(world,this, 3,16);
    }
