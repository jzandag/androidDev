 ...
 */
public class Level07 extends ZidPlayScreens implements Screen {
    private static final int LEVEL_NUMBER = 7;

    public Level07(Elective4 game) {
        super(game);
        // Only changes needed
        map = new TmxMapLoader().load("map/Level 07 Living Room.tmx");
        player = new Player(world,this, 7,10);
    }
